...
class COCODataset(JointsDataset):
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path,
        ...
        for idx, kpt in enumerate(preds):
            ...
            if self.image_set == 'validate_infant':
                _img = int(img_path[idx][37:-4])
            elif self.image_set == 'train_I_infant' or self.image_set == 'train_II_infant' or self.image_set == 'train_III_infant' or self.image_set == 'train_infant':
                _img = int(img_path[idx][39:-4])
            else:
